...
void showGoalInfoModal(BuildContext context, GoalDto goal) async {
  ...
  final hasDescription = goal.description != null && goal.description!.isNotEmpty;
  final hasPeriodicity = goal.notificationsTime != null;
          ...
          if (hasPeriodicity) ...[
            ...
            Text(
              "${l10n.modalGoalInfoPeriodicityLabel}: "
                  "${goal.notificationsTime!.joinWeekDaysShort()}",
              style: TextStyle(
                color: AppColors.hintText,
              ),
            ),
