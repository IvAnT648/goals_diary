...
import '../../data/repository/goals.dart' as _i13;
...
import '../../domain/usecases/get_activities.dart' as _i9;
import '../../domain/usecases/get_my_goals.dart' as _i23;
import '../../domain/usecases/get_posts.dart' as _i11;
import '../../domain/usecases/get_subscriptions.dart' as _i12;
import '../../domain/usecases/profile.dart' as _i10;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i9.GetActivitiesUseCase>(() => _i9.GetActivitiesUseCaseImpl());
  gh.factory<_i10.GetOwnProfileInfoUseCase>(
      () => _i10.GetOwnProfileInfoUseCaseImpl());
  gh.factory<_i11.GetPostsUseCase>(() => _i11.GetPostsUseCaseMock());
  gh.factory<_i12.GetSubscriptionsUseCase>(
      () => _i12.GetSubscriptionsUseCaseMock());
  gh.factory<_i13.GoalsRepository>(
      () => _i13.GoalsRepositoryImpl(get<_i6.AuthRepository>()));
  gh.factory<_i14.IsLoggedInUseCase>(
      () => _i14.IsLoggedInUseCaseImpl(get<_i6.AuthRepository>()));
  gh.factory<_i14.LogoutUseCase>(
      () => _i14.LogoutUseCaseImpl(get<_i7.EmailAuthRepository>()));
  ...
  gh.factory<_i17.SaveGoalUseCase>(
      () => _i17.SaveGoalUseCaseImpl(get<_i13.GoalsRepository>()));
  gh.factory<_i14.SignInUseCase>(
      () => _i14.SignInUseCaseImpl(get<_i7.EmailAuthRepository>()));
  gh.factory<_i14.SignUpUseCase>(
      () => _i14.SignUpUseCaseImpl(get<_i7.EmailAuthRepository>()));
  ...
  gh.factory<_i20.ActivityRepository>(
      () => _i20.ActivityRepositoryImpl(get<_i13.GoalsRepository>()));
  gh.factory<_i21.DeleteGoalUseCase>(
      () => _i21.DeleteGoalUseCaseImpl(get<_i13.GoalsRepository>()));
  gh.factory<_i22.EditGoalCubit>(() => _i22.EditGoalCubit(
      get<_i17.SaveGoalUseCase>(), get<_i21.DeleteGoalUseCase>()));
  gh.factory<_i23.GetMyGoalsUseCase>(
      () => _i23.GetMyGoalsUseCaseImpl(get<_i13.GoalsRepository>()));
  gh.factory<_i24.SignInCubit>(
      () => _i24.SignInCubit(get<_i14.SignInUseCase>()));
  gh.factory<_i25.SignUpCubit>(
      () => _i25.SignUpCubit(get<_i14.SignUpUseCase>()));
  return get;
}
